...
alloc_with_xib(EFCircularSlider)
-(void)awakeFromNib
{
    [self initData];
...
-(void)initData
{
    ...
    _filledColor = [GeneralizedProcessor hexStringToColor:colorRead];
    _handleColor = _filledColor;
    _labelFont = [UIFont systemFontOfSize:10.0f];
    _snapToLabels = NO;
    _handleType = semiTransparentWhiteCircle;
    _labelColor = [GeneralizedProcessor hexStringToColor:colorRead];
