...
- (void)loginByWay:(int)way name:(NSString *)mName
{
   ...
   // [UMSocialQQHandler setQQWithAppId:@"1104451983" appKey:@"cwtGukJMHbbHa9hO" url:@"http://www.umeng.com/social"];
...
-(void)forgetpassword{
   ...
   ForgotpasswordViewController  *RP=[[ForgotpasswordViewController alloc]init];
...
- (void)createUI
{
   ...
   self.view.backgroundColor=[GeneralizedProcessor hexStringToColor:@"#f9f9f9"];
    ...
    _xianImageView.backgroundColor=[GeneralizedProcessor hexStringToColor:@"d8d8d8"];
   
        _xianTwo.backgroundColor=[GeneralizedProcessor hexStringToColor:@"d8d8d8"];
    _xianThree.backgroundColor=[GeneralizedProcessor hexStringToColor:@"d8d8d8"];
    ...
    _nameField.textColor=[GeneralizedProcessor hexStringToColor:@"#929292" ];
    ...
    _passwordField.layer.borderColor=[[UIColor clearColor]CGColor];


    _loginBtn.layer.cornerRadius = 5;
    _loginBtn.layer.masksToBounds = YES;
    _loginBtn.titleLabel.font=[UIFont fontWithName:@"Helvetica" size:Placeholder];
    _loginBtn.backgroundColor=[GeneralizedProcessor hexStringToColor:@"#ea2a2a"];
