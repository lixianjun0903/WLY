...
@interface SecondFriendViewController ()<UITableViewDataSource,UITableViewDelegate>
@property (weak, nonatomic) IBOutlet UITableView *tableView;
@property (nonatomic,strong) NSMutableArray * dataArray;
@end

@implementation SecondFriendViewController
...
-(void)loadData
{
    ...
    self.dataArray = [NSMutableArray arrayWithCapacity:0];
    [model loadFriendData:0 urlbool:NO controller:self finish:^(NSArray * array) {
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell configFriend:friend add:YES];
    return cell;
}
