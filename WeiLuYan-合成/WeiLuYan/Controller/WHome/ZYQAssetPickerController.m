...
+ (void)initialize
{
    ...
    checkedIcon = [UIImage imageNamed:@"OK.png"];
    ...
    checkedNoIcon = [UIImage imageNamed:@"No.png"];
...
-(id)initWithFrame:(CGRect)frame{
    if (self=[super initWithFrame:frame]) {
        //设置勾勾的位置
        _selectView=[[UIImageView alloc] initWithFrame:CGRectMake(frame.size.width-checkedIcon.size.width/2-2, 2, checkedIcon.size.width/2, checkedIcon.size.height/2)];
