...
@property (nonatomic, weak) FavoritePersonCell *parentCell;
@property (nonatomic) SEL utilityButtonSelector;

- (id)initWithUtilityButtons:(NSArray *)utilityButtons parentCell:(FavoritePersonCell *)parentCell utilityButtonSelector:(SEL)utilityButtonSelector;

- (id)initWithFrame:(CGRect)frame utilityButtons:(NSArray *)utilityButtons parentCell:(FavoritePersonCell *)parentCell utilityButtonSelector:(SEL)utilityButtonSelector;
...
@interface FavoritePersonCell () <UIScrollViewDelegate> {
...
@implementation FavoritePersonCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier containingTableView:(UITableView *)containingTableView leftUtilityButtons:(NSArray *)leftUtilityButtons rightUtilityButtons:(NSArray *)rightUtilityButtons {
    ...
    if (self) {
        ...
        self.height = [self getCellHeight];
...
-(void)setAttentionObject:(attentionObject *)attentionObject{
    [_iconImageView sd_setImageWithURL:[NSURL URLWithString:attentionObject.avatar] placeholderImage:[UIImage imageNamed:@"touxiang"]];
    
    _nameLabel.text = attentionObject.real_name;
    NSString *title = [NSString stringWithFormat:@"%@  %@",(attentionObject.company),(attentionObject.office)];
    _titleLabel.text = title;
    int member_id = attentionObject.member_id;
    self.tag = member_id;
}
...
- (CGFloat)getCellHeight{
    ...
    CGFloat cellHeight = labelsize.height*2 + 52;
    return cellHeight;
}
...
- (void)initializer {
    ...
    CGFloat imageWH = cellHeight - 20;
    _iconImageView = [[UIImageView alloc] initWithFrame:CGRectMake(20, 10, imageWH, imageWH)];
    _iconImageView.layer.masksToBounds = YES;
    _iconImageView.layer.cornerRadius = imageWH/2;
    
    _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(imageWH+34, 21, 200, labelsize.height)];
    
    CGFloat titleY = 21 + labelsize.height+10.5;
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(imageWH+34, titleY, 200, labelsize.height)];
